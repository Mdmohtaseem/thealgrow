...
const Header5 = () => {
    ...
    return (
        <>
            ...
            <header className={`header-area style-5 ${pathname === "/portfolio/carousel" || pathname === "/digital-agency" || pathname === "/digital-agency-dark" ? "position-absolute" : ""} ${state.scrollY > 20 ? "sticky" : ""}`}>
                        ...
                        <div className="search-bar d-lg-flex d-none">
                            <div className="search-btn" onClick={toggleSearchBar}>
                                <svg width={18} height={18} viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M8.20349 1.44873C6.41514 1.45173 4.70089 2.16348 3.43633 3.42803C2.17178 4.69259 1.46003 6.40684 1.45703 8.19519C1.45853 9.98505 2.16943 11.7013 3.43399 12.968C4.69855 14.2347 6.41364 14.9485 8.20349 14.953C9.79089 14.953 11.2536 14.3946 12.4101 13.4705L16.0578 17.1184C16.2002 17.2508 16.3882 17.3228 16.5825 17.3194C16.7768 17.316 16.9622 17.2374 17.0998 17.1002C17.2374 16.963 17.3165 16.7778 17.3204 16.5835C17.3243 16.3892 17.2528 16.2009 17.1208 16.0583L13.4731 12.4075C14.4325 11.2143 14.9556 9.72911 14.9556 8.19802C14.9556 4.47897 11.9225 1.44873 8.20349 1.44873ZM8.20349 2.95109C11.1118 2.95109 13.4533 5.28968 13.4533 8.19519C13.4533 11.1007 11.1118 13.4535 8.20349 13.4535C5.29514 13.4535 2.95656 11.1092 2.95656 8.20086C2.95656 5.29251 5.29514 2.95109 8.20349 2.95109Z" />
                                </svg>
                            </div>
                            <div className={`search-input ${state.isSearchBarOpen ? "active" : ""
                                ...
                                <form>
                                    ...
                                    <div className="quick-search">
                                        <ul>
                                            <li>Quick Search :</li>
                                            <li><Link href="#">Network Infrastructure,</Link></li>
                                            <li><Link href="#">Cybersecurity Services,</Link></li>
                                            <li><Link href="#">Affiliate Marketing,</Link></li>
                                            <li><Link href="#">UX Elevate,</Link></li>
                                            <li><Link href="#">Digital Marketing,</Link></li>
                                            <li><Link href="#">E-commerce Solutions,</Link></li>
                                            <li><Link href="#">Consulting &amp; Strategy,</Link></li>
                                        </ul>
                                    </div>
                                </form>
                            </div>
                        </div>
                        <Link className="primary-btn5 two white-bg d-lg-flex d-none" href="/contact">
                            Let’s Talk
                            <svg width={10} height={10} viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
                                <path d="M1 9L9 1M9 1C7.22222 1.33333 3.33333 2 1 1M9 1C8.66667 2.66667 8 6.33333 9 9" strokeWidth="1.5" strokeLinecap="round" />
                            </svg>
