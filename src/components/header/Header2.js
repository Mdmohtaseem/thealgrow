                ...
                <div className={`main-menu ${state.isSidebarOpen ? "show-menu" : ""}`}>
                    <div className="mobile-logo-area d-lg-none d-flex align-items-center justify-content-between">
                        <Link href="/" className="mobile-logo-wrap">
                            <img alt="image" className="img-fluid" src="/assets/img/header-logo-white.svg" />
                        </Link>
                    ...
                    <ul className="menu-list">
                        ...
                        <li className={`menu-item-has-children position-inherit ${pathname === "/industry/details" ? "active" : ""}`}>
                            <Link href="/service" className="drop-down">
                                ...
                                <svg width="8" height="8" viewBox="0 0 8 8" xmlns="http://www.w3.org/2000/svg">
                                    <g>
                                        <path d="M1 7L7 1M7 1C5.66667 1.25 2.75 1.75 1 1M7 1C6.75 2.25 6.25 5 7 7" stroke-width="1.5" stroke-linecap="round" />
                                    </g>
                                </svg>
                            </Link>
                        ...
                        <li className={`menu-item-has-children ${isCompanyActive ? "active" : ""}`}>
                            <Link href="/case-study" className="drop-down">
                                Company
                                <svg width="8" height="8" viewBox="0 0 8 8" xmlns="http://www.w3.org/2000/svg">
                                    <g>
                                        <path d="M1 7L7 1M7 1C5.66667 1.25 2.75 1.75 1 1M7 1C6.75 2.25 6.25 5 7 7" stroke-width="1.5" stroke-linecap="round" />
                        ...
                        <li className="menu-item-has-children position-inherit">
                            <a href="#" className="drop-down">Resources <svg width="8" height="8" viewBox="0 0 8 8" xmlns="http://www.w3.org/2000/svg">
                                <g>
                                    <path d="M1 7L7 1M7 1C5.66667 1.25 2.75 1.75 1 1M7 1C6.75 2.25 6.25 5 7 7" stroke-width="1.5" stroke-linecap="round" />
                                </g>
                            </svg>
