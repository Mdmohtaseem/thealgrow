                        ...
                        <div className="col-lg-6">
                            <div className="banner-content-wrap">
                                <div className="banner-content">
                                    <span>Global Digital Growth Agency</span>
                                    <h1>Building Scalable Digital Systems That Drive Revenue.</h1>
                                    <p>We help growth-focused businesses scale with <span>high-performance digital platforms, strategic branding, performance marketing, automation, and AI-powered solutions</span> engineered for measurable growth</p>
                                    <div className="btn-and-counter-area">
                                        ...
                                        <div className="counter-area d-none d-lg-flex">
                                            <div className="icon">
