            ...
            <div className="home5-process-section">
                <div className="container">
                        ...
                        <div className="row gy-md-5 gy-4">
                            <div className="col-lg-3 col-md-6 col-sm-6">
                                <div className="process-card3">
                                    ...
                                    <p>We analyze your business and define a clear strategy.</p>
                                </div>
                            </div>
                            <div className="col-lg-3 col-md-6 col-sm-6 d-flex justify-content-lg-center">
                                <div className="process-card3">
                                    ...
                                    <p>We design and build scalable digital platforms.</p>
                                </div>
                            </div>
                            <div className="col-lg-3 col-md-6 col-sm-6 d-flex justify-content-lg-center">
                                <div className="process-card3">
                                    ...
                                    <p>We launch campaigns and automate growth systems.</p>
                                </div>
                            </div>
                            <div className="col-lg-3 col-md-6 col-sm-6 d-flex justify-content-lg-end">
                                <div className="process-card3">
                                    <div className="step-no">
                                        <span>Step</span>
                                        <strong>04</strong>
                                    ...
                                    <p>We optimize performance and scale growth systems.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="contact-area">
                        <p>Ready to grow your business with the right digital strategy</p>
                        <Link href="/contact">
                            Contact Us
