...
const BrandStrategyDetailsPage = () => {
    return (
        <div>
            <Header3 />
                    ...
                    <div className="row justify-content-center">
                        <div className="col-xl-8 col-lg-10">
                            <div className="banner-content">
                                <h1>Brand Strategy & Identification</h1>
                    ...
                    <div className="details-content-wrap mb-130">
                        ...
                        <div className="row gy-4 justify-content-between mb-70">
                            <div className="col-xl-5 col-lg-6">
                                ...
                                <p>We craft compelling brand identities that resonate with your target audience. Our strategy-first approach ensures your brand stands out in the marketplace with a unique voice and consistent visual identity.</p>
                                <span className="line-break" />
                                <p>Our team works closely with you to understand your values and goals, translating them into a strategic brand framework that drives long-term success and customer loyalty.</p>
                            </div>
                            <div className="col-xl-5 col-lg-6">
                                <h2>Key Feature</h2>
                                <span className="line-break" />
                                <p>Here are some key features of Brand Strategy & Identification that highlight:</p>
                                <span className="line-break" />
                        ...
                        <h2>Why Choose Us?</h2>
                        <span className="line-break" />
                        <p className="fixed-width">Elevate your brand with a strategy that resonates. Our data-driven approach to brand identity ensures that every creative element is backed by market research and performance metrics.</p>
                        <span className="line-break" />
                        <span className="line-break" />
                        <div className="row g-4">
                            <div className="col-lg-3 col-md-4 col-sm-6">
                                <div className="single-service two">
                                    <h5><span>1.</span> Creative Strategists</h5>
                                </div>
                            </div>
                            <div className="col-lg-3 col-md-4 col-sm-6">
                                <div className="single-service">
                                    <h5><span>2.</span> Unique Identity Design</h5>
                                </div>
                            </div>
                            <div className="col-lg-3 col-md-4 col-sm-6">
                                <div className="single-service three">
                                    <h5><span>3.</span> Market Position Focus</h5>
                                </div>
                            </div>
                            <div className="col-lg-3 col-md-4 col-sm-6">
                                <div className="single-service">
                                    <h5><span>4.</span> Brand Consistency Support</h5>
                                </div>
                            </div>
                            <div className="col-lg-3 col-md-4 col-sm-6">
                                <div className="single-service">
                                    <h5><span>5.</span> Brand Equity Growth</h5>
                                </div>
                            </div>
                            <div className="col-lg-3 col-md-4 col-sm-6">
                                <div className="single-service four">
                                    <h5><span>6.</span> Client Perception Value</h5>
                                </div>
                            </div>
                            <div className="col-lg-3 col-md-4 col-sm-6">
                                <div className="single-service">
                                    <h5><span>7.</span> Strategic Milestone Hits</h5>
                                </div>
                            </div>
...
export default BrandStrategyDetailsPage
