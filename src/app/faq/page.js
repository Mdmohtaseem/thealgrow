...
const FaqPage = () => {
    return (
        <div>
                        ...
                        <div className="row gy-4 justify-content-between">
                            ...
                            <div className="col-lg-6">
                                <div className="banner-content">
                                    ...
                                    <p>If you have a question that isn’t covered here, feel free to reach out to us directly at <a href="mailto:contact@thealgrow.com">[contact@thealgrow.com].</a></p>
                                ...
                                <div className="accordion accordion-flush" id="accordionFlushExample">
                                    ...
                                    <div className="accordion-item wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                                        ...
                                        <div id="flush-collapseThree" className="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
                                            <div className="accordion-body">
                                                Our typical project timeline varies based on the project's complexity, scope, and requirements. Smaller projects may take a weeks or two, while larger or more complex ones can take a month or more.
                                            </div>
                                        </div>
                                    </div>
                                    <div className="accordion-item wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
                                        ...
                                        <div id="flush-collapseFour" className="accordion-collapse collapse" aria-labelledby="flush-headingFour" data-bs-parent="#accordionFlushExample">
                                            <div className="accordion-body">
                                                Yes! We can help redesign your existing website to improve its look, functionality, and performance. Whether you need a modern refresh, better user experience, or enhanced features, we tailor the redesign to meet your goals. <Link href="/contact">[Contact us]</Link> to discuss your vision!
                                            </div>
                                        </div>
                                    </div>
                                    <div className="accordion-item wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
            ...
            {/* Calendly Section Start */}
            <div className="industries-page-banner three mb-130">
                <div className="container">
                    <div className="banner-content-wrap">
                        <div className="row justify-content-center">
                            <div className="col-12 text-center">
                                <div className="banner-title mb-40">
                                    <h2>Still have questions? Schedule a 1:1 meeting with us.</h2>
                                </div>
                            </div>
                            <div className="col-12 w-100" style={{ position: 'relative', zIndex: 10 }}>
