...
const BlogDetailsPage = ({ params }) => {
    ...
    const nextBlog = blogIndex < blogData.length - 1 ? blogData[blogIndex + 1] : null;
                        ...
                        <div className="col-xl-8 col-lg-10">
                            <div className="banner-content">
                                <ul className="blog-meta">
                                    <li><Link href="/blogs">{blog.category}</Link></li>
                                    <li>
                ...
                <div className="container">
                    <div className="details-content-wrap">
                        <div className="post-thumb mb-70">
                            <img src={blog.detailsImage} alt={blog.detailsTitle} />
                        </div>
                        <div className="row justify-content-center">
                            <div className="col-xl-8 col-lg-10">
                                <h2>{blog.heading1}</h2>
                                ...
                                <blockquote>
                                    ...
                                    <div className="content">
                                        ...
                                        <div className="author-area">
                                            <h6>{blog.quoteAuthor}</h6>
                                            <span>{blog.quotePosition}</span>
                                        </div>
                                    </div>
                                ...
                                {blog.images.length >= 2 ? (
                                    ...
                                    <div className="col-12">
                                        {blog.images.map((img, i) => (
                                            <img key={i} src={img} alt="" style={{ width: '100%', marginBottom: '20px' }} />
                                        ))}
                                    </div>
                                )}
                            </div>
                        ...
                        <div className="row justify-content-center mb-130">
                            <div className="col-xl-8 col-lg-10">
                                ...
                                <div className="row justify-content-center mt-70 mb-50">
                                    <div className="col-lg-12 text-center">
                                        <div className="d-flex justify-content-center gap-3">
                                            <Link href="/services" className="primary-btn3 btn-hover">
                                                View All Services
                                                <span />
                                            </Link>
                                ...
                                <div className="tag-and-social-area d-flex justify-content-start">
                            ...
                            <div className="col-11">
                                <div className="comment-and-form-area">
                                    <div className="inquiry-form">
                                        <h2 className="comment-title text-center mb-4 mb-lg-0">Schedule a 1:1 meeting</h2>
                                ...
                                <div className="details-pagination">
                                    {prevBlog && (
                                        <div className="single-pagination">
                                            <Link className="pagination-btn" href={`/blogs/${prevBlog.slug}`}>
                                            ...
                                            <div className="content">
                                                <h6><Link href={`/blogs/${prevBlog.slug}`}>{prevBlog.listingTitle}</Link></h6>
                                            </div>
                                        </div>
                                    )}
                                    {nextBlog && (
                                        <div className="single-pagination two text-end">
                                            <div className="content">
                                                <h6><Link href={`/blogs/${nextBlog.slug}`}>{nextBlog.listingTitle}</Link></h6>
                                            </div>
                                            <Link className="pagination-btn" href={`/blogs/${nextBlog.slug}`}>
