...
import { dmsans, suseSans, lora, dancingScript } from "@/fonts/font";
...
export default function RootLayout({ children }) {
  ...
  return (
    <html lang="en">
      ...
      <body id="body" className={`tt-magic-cursor ${lora.variable} ${dmsans.variable} ${suseSans.variable} ${dancingScript.variable}`}>

        {pathname !== "/portfolio/vertical" && pathname !== "/portfolio" && <SmoothPageScroll />}
        {children}
        <AnimatedCursor
          innerSize={0}
          outerSize={16}
